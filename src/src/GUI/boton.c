...
Cuadro* createCuad(){
    Cuadro *cuadro = (Cuadro*)calloc(1, sizeof(Cuadro));

    cuadro -> pos.unpack.x = estadosrender.w_width / 3.f;
    cuadro -> pos.unpack.y = estadosrender.w_height / 3.f;

    cuadro -> w = 100;
    cuadro -> h = 100;

    cuadro -> color = (Color){0xFFFFFFFF};
    cuadro -> type = CUADRO;
